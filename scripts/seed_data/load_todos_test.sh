...
# Todo Table Items
aws dynamodb put-item --table-name flask-starter-test-todos --item '{"id":{"S":"todo01"},"title":{"S":"Complete Timesheet"}}'
aws dynamodb put-item --table-name flask-starter-test-todos --item '{"id":{"S":"todo02"},"title":{"S":"Civic Tech"},"description":{"S":"Prep for Serverless Session"}, "is_complete":{"BOOL":true}}'
